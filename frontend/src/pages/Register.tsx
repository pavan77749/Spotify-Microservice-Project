...
import { FaSpotify, FaEye, FaEyeSlash, FaEnvelope, FaLock, FaUser } from 'react-icons/fa';
  ...
  return (
     <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-green-900 p-4'>
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-gray-800/50 text-white p-8 rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 ">
                    ...
                    <p className="text-gray-400 text-center mb-8">Register to continue your music journey</p>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                <FaUser className={`absolute left-4 top-1/2 transform -translate-y-1/2 transition-colors duration-200 ${
                                    focusedInput === 'name' ? 'text-green-500' : 'text-gray-500'
                                }`} />
                                <input 
                                    type="text" 
